...
class MyAxis extends THREE.Object3D {
     ...
     */
    constructor(app,  opacity = 1.0, size = 2, baseRadius = 0.05, xxColor = 0xff0000, yyColor = 0x00ff00, zzColor = 0x0000ff) {
        super();
        this.app = app;
        this.type = 'Group';
        this.size = size;
        this.baseRadius = baseRadius
        this.xxColor = xxColor 
        this.yyColor = yyColor
        this.zzColor = zzColor

        // a cone geometry for the xx axis
        const xx = new THREE.ConeGeometry( this.baseRadius, this.size, 32 ); 
        const xxMaterial = new THREE.MeshBasicMaterial( {color: this.xxColor, transparent: true, opacity: opacity} );
        ...
        const yyMaterial = new THREE.MeshBasicMaterial( {color: this.yyColor, transparent: true, opacity: opacity} );
        ...
        const zzMaterial = new THREE.MeshBasicMaterial( {color: this.zzColor, transparent: true, opacity: opacity} );
